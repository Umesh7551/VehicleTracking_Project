...
urlpatterns = [
    ...
    path('fleetowner/dashboard/', views.fleetowner_dashboard, name='fleetowner_dashboard'),
    ...
    path('edit_support_user/<int:id>/', views.edit_fleetowner_support_user, name='edit_support_user'),
    path('delete_support_user/<int:id>/', views.delete_fleetowner_support_user, name='delete_support_user'),
