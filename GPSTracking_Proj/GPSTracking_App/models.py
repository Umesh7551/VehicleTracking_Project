...
class Car(models.Model):
    ...
    owner = models.ForeignKey(FleetOwner, on_delete=models.CASCADE, default=1)
...
class Tracker_data(models.Model):
    ...
    speed = models.CharField(verbose_name='Speed', max_length=10)
    accuracy = models.CharField(verbose_name='Accuracy', max_length=10)
